...
function getMaven(version, localPath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // }
        let toolPath = yield extractMaven(version, localPath);
        toolPath = path.join(toolPath, 'bin');
        core.addPath(toolPath);
    });
}
exports.getMaven = getMaven;
function extractMaven(version, localPath) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!localPath) {
            core.error("localPath was not provided: " + localPath);
        }
        // Use the locally stored file
        const extractedPath = yield tc.extractTar(localPath);
